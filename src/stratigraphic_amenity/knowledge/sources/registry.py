...
# under OGL-Ontario. This prototype remains non-default until source validation
# and provenance requirements in docs/providers.md are satisfied.
OGS_MDI_ENDPOINT = (
    ...
    return SourceRegistry(
        [
            SourceDefinition(
                ...
                license="CC0-1.0 / United States government public domain",
